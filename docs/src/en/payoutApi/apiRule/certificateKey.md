...
The public/private key generated by the merchant side needs to follow the agreed [public/private key algorithm](/en/payoutApi/apiRule/certificateKey#public-private-key-algorithm) for generation rules, otherwise there may be a problem of signature verification failure.
