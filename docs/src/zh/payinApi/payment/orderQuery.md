...
| complainStatus          | string   | 订单投诉状态：<br> `normal`：正常订单 <br> `complained`：投诉订单                                                                                                             | "normal"                                           |
...
```json
{
  ...
  "beneficiary": "{\"platform\":\"PUBG\",\"info\":\"ACCOUNT123_UID12345\"}", // 受益人信息
  ...
  "status": "pending", // 订单状态
  "complainStatus": "complainStatus", // 订单投诉状态
