...
| currency                                                  | string          | 是       | 货币种类，三位大写字母                                                          | "SAR"<br>"AED"<br>"BHD"<br>"EGP"<br>"EUR"<br>"GBP"<br>"KWD"<br>"OMR"<br>"QAR"<br>"USD"|
...
在成功创建支付订单后，依据返回的响应参数，构造收银台 URL，在 iframe 内嵌的收银台，需要指定具体的支付方式
